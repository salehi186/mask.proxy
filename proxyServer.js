...
class Proxy {
    ...
    httpHandler(userRequest, userResponse) {
        if (debugging) 
        ...
        var proxyRequest = http.request(options, function (proxyResponse) {
            ...
            proxyResponse.pipe(userResponse, {end: true});
        });
        ...
        userRequest.pipe(proxyRequest, {end: true});
    }
    httpsHandler(request, socketRequest, bodyhead) {
        ...
        proxySocket.pipe(socketRequest, {end: true});
